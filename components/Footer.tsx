...
export function Footer() {
  return (
    <footer className="border flex flex-col text-gray-600 text-sm ">
      <div className="border-t border-b flex  justify-center  border-gray-200"> {/* {{ edit_1 }} */}
        {/* Top banner */}
        <div className="flex justify-between flex-wrap gap-8 items-center py-4 ">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8 py-8 lg:px-[350px] ">
        <div>
        ...
        <div className="col-span-2 md:col-span-1">
          ...
          <div className="flex space-x-2">
            <Link href="#" className="bg-black text-white p-2 rounded-sm">
      ...
      {/* Bottom section */}
      <div className="flex flex-wrap justify-center gap-7 items-center py-8 border-t border-gray-200">
        <div className="flex flex-wrap space-x-4 text-[10px]">
          <Link href="#" className="bg-gray-900 text-white px-2 rounded-xl py-2  flex items-center space-x-2">
            <span>Download on the</span>
            <span className="">App Store</span>
          </Link>
          <Link href="#" className="bg-gray-900 text-white px-4 py-2 rounded-md flex items-center space-x-2">
            <span>GET IT ON</span>
            <span className="font-semibold">Google Play</span>
          </Link>
          <Link href="#" className="bg-gray-900 text-white px-4 py-2 rounded-md flex items-center space-x-2">
            <span>Download on the</span>
            <span className="font-semibold">Mac App Store</span>
          </Link>
          <Link href="#" className="bg-gray-900 text-white px-4 py-2 rounded-md flex items-center space-x-2">
